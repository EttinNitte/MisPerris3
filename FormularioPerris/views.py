...
def index(request):
    ...
    tipoVivienda = request.POST.get('tipoVivienda',0)
    adoptante = Adoptante(correo = correo, run = rut, nombreCompleto = nombre, pefechaNacimiento = fechaNac,telefono = telefono,region = regiones,comuna = comunas,tipoVivienda = tipoVivienda)
    adoptante.save()
